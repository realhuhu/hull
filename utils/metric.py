...
# 调整后的score函数，可以传入多种格式的submission
def score(solution: pd.DataFrame, submission: Union[np.ndarray, pd.DataFrame, int]) -> float:
    """
    ...
    """
    submission = pd.DataFrame({'prediction': submission}, index=solution.index)
